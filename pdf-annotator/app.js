...
document.getElementById('sample-btn').addEventListener('click', () => openPdf(SAMPLE_URL));
document.getElementById('empty-sample').addEventListener('click', () => openPdf(SAMPLE_URL));
